...
namespace OpenTK_winforms_z02 {
    public partial class Form1 : Form {
        ...
        //stari de control pentru piramida
        private bool statusPyramidT;
        private bool statusPyramidTex1;
        private bool statusPyramidTex2;
        private bool statusPyramidTex3;
        private bool statusPyramidTex4;
        ...
        //Tema:Structuri de stocare a vertexurilor și a listelor de vertexuri Pt Piramida
        private int[] arrPyramidList = new int[100];
        private int nPyramidList;
        ...
        //Acelasi lucru dar pentru piramida
        private void setPyramidStatus(string status)
        {
            if (status.Trim().ToUpper().Equals("TRIANGLES"))
            {
                statusPyramid = "TRIANGLES";
            }
            else if (status.Trim().ToUpper().Equals("QUADS"))
            {
                statusPyramid = "QUADS";
        ...
        private void LoadTextures() {
            ...
            LoadTexture(textures[1], "Laughing_at_Massacre.jpg");
        }
        ...
        private void resetTexPyramid()
        {
            setPyramidStatus("OFF");
            statusPyramidTex1 = false;
            statusPyramidTex2 = false;
            statusPyramidTex3 = false;
            statusPyramidTex4 = false;
            GlControl1.Invalidate();
        }
        ...
        //LABORATORUL 9-TEMA
        //Deseneaza Piramida -quads-textura 1-100%

        private void DeseneazaPiramidaQ()
        {
            GL.BindTexture(TextureTarget.Texture2D, textures[0]);
            GL.Color3(Color.White);
            // Desenează piramida - de exemplu, cu quads
            GL.Begin(PrimitiveType.Quads);

            // Fața piramidei
            GL.TexCoord2(0.0, 0.0);
            GL.Vertex3(-20.0, -20.0, -20.0);
            GL.TexCoord2(20.0, 0.0);
            GL.Vertex3(20.0, -20.0, -20.0);
            GL.TexCoord2(20.0, 20.0);
            GL.Vertex3(20.0, -20.0, 20.0);
            GL.TexCoord2(0.0, 20.0);
            GL.Vertex3(-20.0, -20.0, 20.0);
